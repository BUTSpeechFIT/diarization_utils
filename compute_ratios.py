...
# Copyright Gwangju Institute of Science and Technology (Dongkeon Park)
...
def parse_arguments() -> SimpleNamespace:
    parser = argparse.ArgumentParser(
        description='Compute ratio for silence, speech and overlap from rttms')
...
def main():
    ...
    with open(args.out_file, 'w') as f:
        ...
        for line in list:
            ...
            speech_seconds = seconds - seconds_sil
            ...
            all_seconds += seconds
            all_speech_seconds += speech_seconds
